        ...
        <div className="w-full max-w-[85rem] px-4 text-center -mt-8 sm:mt-0 pt-28 pb-8 sm:pt-32 md:pt-36 lg:pt-40">
          ...
          >
            <p className="font-medium">
              {language === 'lv' 
               ? <>Jaudīgākais batutu fitness Latvijā – kopā ar <span className="text-[#FBBF24]">Aleksandru Kurusovu</span>! Enerģiskākās grupu <span className="text-[#FBBF24]">nodarbības Rīgā un Piņķos</span>.<br/>Lēkā, sporto un baudi kustību kā vēl nekad!</>
